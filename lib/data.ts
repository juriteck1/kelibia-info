...
export const EVENTS: Event[] = [
  { id: 1, title: 'Festival de la Mer de Kélibia', desc: "Célébration annuelle de la culture maritime avec musique, danse et gastronomie.", date: '2025-06-15', time: '18:00', loc: 'Plage principale de Kélibia', cat: 'Festival', img: 'https://images.unsplash.com/photo-1533900298318-6b8da08a523e?w=800&q=80', attendees: 2500, featured: true },
  { id: 2, title: "Marché nocturne de l'artisanat", desc: "Marché artisanal nocturne avec produits locaux et musique traditionnelle.", date: '2025-05-24', time: '19:00', loc: 'Centre-ville, Kélibia', cat: 'Marché', img: 'https://images.unsplash.com/photo-1552820728-8ac41f1ce891?w=800&q=80', attendees: 800, featured: false },
  { id: 3, title: 'Tournoi de pêche sportive', desc: "Compétition de pêche en mer ouverte aux amateurs et professionnels.", date: '2025-05-10', time: '06:00', loc: 'Port de pêche, Kélibia', cat: 'Sport', img: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800&q=80', attendees: 120, featured: false },
  { id: 4, title: 'Visite guidée du Fort', desc: "Visite historique guidée du fort byzantin.", date: '2025-05-17', time: '10:00', loc: 'Fort de Kélibia', cat: 'Visite guidée', img: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663540319411/XQhkcmuSh54XAQGXS9GFbu/kelibia-fort-9qNGjKHZBqromt4JugQjkM.webp', attendees: 45, featured: false },
  { id: 5, title: 'Cours de cuisine méditerranéenne', desc: "Atelier culinaire pour apprendre les plats tunisiens traditionnels.", date: '2025-05-20', time: '15:00', loc: 'Centre culturel, Kélibia', cat: 'Atelier', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&q=80', attendees: 30, featured: false },
  { id: 6, title: 'Nuit du cinéma en plein air', desc: "Projection de films tunisiens sous les étoiles.", date: '2025-06-01', time: '20:00', loc: 'Plage de Mansourah', cat: 'Culture', img: 'https://images.unsplash.com/photo-1489599849228-ed4dc59b2e9b?w=800&q=80', attendees: 500, featured: false },
]
